...
#include <libcli2/parsing/int.h>
#include <libcli2/parsing/string.h>
#include <libcli2/types.h>
...
typedef void (*cli_callback_t)(cli_parsed_param_t* args, size_t num_args);

typedef struct {
  char argument_name;
  cli_callback_t callback;
  cli_param_type_t* args_types;
  size_t num_params;
} cli_command_t;
